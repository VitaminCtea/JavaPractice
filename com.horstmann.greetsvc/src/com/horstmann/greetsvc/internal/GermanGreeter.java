...
public class GermanGreeter implements GreeterService {
    ...
    public GermanGreeter(Map<String, String> dictionary) { this.dictionary = dictionary; }

    @Override
    public String greet(String subject) { return "Hallo, " + dictionary.getOrDefault(subject, subject) + "!"; }
